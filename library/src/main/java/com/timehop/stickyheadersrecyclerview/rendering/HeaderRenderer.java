...
public class HeaderRenderer {
    ...
    /**
     * The following field is used as a buffer for internal calculations. Its sole purpose is to avoid allocating new Rect every
     * time we need one.
     */
     ...
     * @param offset a Rect used to define the x/y offset of the header. Specify x/y offset by setting the {@link Rect#left} and
     * {@link Rect#top} properties, respectively.
     */
    ...
    /**
     * Initializes a clipping rect for the header based on the margins of the header and the padding of the recycler. FIXME:
     * Currently right margin in VERTICAL orientation and bottom margin in HORIZONTAL orientation are clipped so they look accurate,
