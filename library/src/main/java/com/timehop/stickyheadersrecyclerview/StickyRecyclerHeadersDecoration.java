...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            boolean hasStickyHeader =
              mHeaderPositionCalculator.hasStickyHeader(itemView, mOrientationProvider.getOrientation(parent), position);
    ...
    /**
     * Gets the header view for the associated position.  If it doesn't exist yet, it will be created, measured, and laid out.
     *
    ...
    /**
     * Invalidates cached headers.  This does not invalidate the recyclerview, you should do that manually after calling this
     * method.
     */
